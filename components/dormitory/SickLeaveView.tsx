...
export const SickLeaveView: React.FC = () => {
    // State for Form
    ...
    async function fetchData() {
        ...
        try {
            ...
            // Fetch sick leave permissions for recap
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const { error } = await supabase.from('dormitory_permissions').insert({
            ...
            date,
            type: DormitoryPermissionType.SICK_LEAVE,
    ...
    return (
        <div className="space-y-8">
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-lg border border-slate-200">
                <h2 className="text-3xl font-bold text-slate-800 mb-6 border-b pb-4">إذن الخروج للمريض</h2>
                {message && (
            ...
            <div className="space-y-6">
                 <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200 printable-area">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-2xl font-bold text-slate-800">ملخص إذن الخروج للمريض</h3>
