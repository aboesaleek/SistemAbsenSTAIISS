...
export const IndividualLeaveRecapView: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="no-print">
                <h2 className="text-3xl font-bold text-slate-800">ملخص إذن الخروج الفردي</h2>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200 printable-area">
                <h3 className="text-2xl font-bold text-slate-800 mb-4 hidden print:block">ملخص إذن الخروج الفردي</h3>
